 ...
 *
 * =>  @see ./src/schemas/models/EventDataBusiness.yml
 *
...
export const schemaForEventDataBusiness = {$id: "EventDataBusiness.yml", $ref: "Event.yml"};

export function validateEventDataBusiness(o: object): {isValid: boolean; validate: ValidateFunction} {
  const ajv = new Ajv();
  addFormats(ajv);
  ...
  const validate = ajv.compile(schemaForEventDataBusiness);
  return {isValid: validate(o), validate: validate};
}

export interface EventDataBusiness {
  type?: "type.Event";
  identifier: string;
  metadata?: Metadata;
