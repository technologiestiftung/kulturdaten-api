 ...
 *
 * =>  @see ./src/schemas/models/CommandEventCreate.yml
 *
...
export const schemaForCommandEventCreate = {
  $id: "CommandEventCreate.yml",
  type: "object",
  properties: {
...
export function validateCommandEventCreate(o: object): {isValid: boolean; validate: ValidateFunction} {
  const ajv = new Ajv();
  addFormats(ajv);
  ...
  const validate = ajv.compile(schemaForCommandEventCreate);
  return {isValid: validate(o), validate: validate};
}

export interface CommandEventCreate {
