 ...
 *
 * =>  @see ./src/schemas/models/CommandLocationCreate.yml
 *
...
export const schemaForCommandLocationCreate = {
  $id: "CommandLocationCreate.yml",
  type: "object",
  properties: {
...
export function validateCommandLocationCreate(o: object): {isValid: boolean; validate: ValidateFunction} {
  const ajv = new Ajv();
  addFormats(ajv);
  ...
  const validate = ajv.compile(schemaForCommandLocationCreate);
  return {isValid: validate(o), validate: validate};
}

export interface CommandLocationCreate {
