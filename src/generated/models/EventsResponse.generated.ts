 ...
 *
 * =>  @see ./src/schemas/models/EventsResponse.yml
 *
...
export const schemaForEventsResponse = {
  $id: "EventsResponse.yml",
  type: "object",
  properties: {
...
export function validateEventsResponse(o: object): {isValid: boolean; validate: ValidateFunction} {
  const ajv = new Ajv();
  addFormats(ajv);
  ...
  const validate = ajv.compile(schemaForEventsResponse);
