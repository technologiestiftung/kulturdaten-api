...
describe('DistrictDataMapper', () => {
  ...
  describe('map attraction', () => {
    it('should correctly map Veranstaltung to CreateAttractionRequest', () => {
      const expectedResult: CreateAttractionRequest = {
        ...
        "family": false,
        "tags": [
          "attraction.category.WeeklyMarkets"
        ],
        "externalLinks": [
          {
  ...
  describe('map event', () => {
    it('should correctly map Termin to CreateEventRequest', () => {
      ...
      const result = mapper.mapEvent(termin, veranstaltung, {referenceId: "a_1"}, {referenceId: "l_1"}, {referenceId: "o_1"});
...
export const veranstaltung: Veranstaltung = {
  ...
  "event_titel_ru": "",
  "event_titel_tr": "",
  "event_beschreibung_de": "Unser Trödelmarkt bietet Gelegenheit, Spielzeug, Kinderwagen, Babybekleidung und vieles andere zu verkaufen oder günstig zu erwerben.\r\nWir stellen Tische (200 cm x 40 cm) und Bänke.\r\n\r\n\r\nOrt: Höfe der Fabrik Osloer Straße",
