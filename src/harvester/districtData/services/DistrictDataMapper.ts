...
export class DistrictDataMapper {
	...
	mapLocation(
		...
		const accessibilityTags: string[] | undefined = veranstaltungsort.barrierefreiheit ?  this.mapAccessibilityTags(veranstaltungsort.barrierefreiheit, allTags) : undefined;
