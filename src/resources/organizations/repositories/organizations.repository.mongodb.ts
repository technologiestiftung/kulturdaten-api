...
export class MongoDBOrganizationsRepository implements OrganizationsRepository {
	...
	async get(filter?: Filter, projection?: any, pagination?: Pagination): Promise<any[]> {
		...
		let query = organizations.find(filter || {}, { projection: projection || MONGO_DB_DEFAULT_PROJECTION });
	...
	async getOrganizationsAsReferences(pagination?: Pagination): Promise<Reference[] | null> {
